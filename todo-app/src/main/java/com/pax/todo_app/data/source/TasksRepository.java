...
package com.pax.todo_app.data.source;
...
public class TasksRepository implements TasksDataSource {
    ...
    @Inject
    TasksRepository(@Remote @NonNull TasksDataSource tasksRemoteDataSource,
                    @Local @NonNull TasksDataSource tasksLocalDataSource) {
